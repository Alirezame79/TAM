...
export default function CreateGroup() {
    ...
    return (
        <div className={classes.content}>
            {modal === "confirm-create-group" && (<ConfirmCreateGroupModal data={groupData} courseId={id} />)}
            <Card creatGroup>
                ...
                <div className={classes.creatGroupInput}>
                    ...
                    <Input id="master" creatGroup placeholder={data.owner.name} readOnly />
                </div>
                <div className={classes.creatGroupInput}>
                    <label htmlFor="discription">توضیجات</label>
                    <Input groupDiscription innerRef={description} />
                </div>
                <Button submit click={createGroupClicked}>اضافه کردن اعضا گروه</Button>
            </Card>
